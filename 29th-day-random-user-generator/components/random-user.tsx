    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground p-4">
      ...
      {loading && (
        <div className="flex items-center justify-center">
          <ClipLoader color="#36D7B7" size={24} className="mr-2" />
          <span>Loading...</span>
        </div>
      )}
      ...
      {user && (
        <Card className="border-0 shadow-lg rounded-lg overflow-hidden max-w-sm relative">
          ...
          <CSSTransition
            ...
            unmountOnExit
            nodeRef={appreciationRef}
          >
            <div ref={appreciationRef} className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-white bg-opacity-75">
